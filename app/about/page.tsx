  ...
  return (
    <div className="mt-12 space-y-12 font-mono max-w-[700px] mx-auto">
      ...
      <section className="space-y-4">
        <h2 className="text-lg">YEEZY</h2>
        <p className="leading-relaxed">
          YEEZY is a minimalist ecommerce template inspired by the design
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed">
          Built using Next.js App Router, TypeScript, and Tailwind CSS, YEEZY
